/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b9dcd3a442ac76311bf93a0a31a18ec)
// Runtime types generated with workerd@1.20260828.1 2026-09-01 
interface __BaseEnv_Env {
	SENSEMAKING_QUEUE: Queue;
	AI: Ai;
	ASSETS: Fetcher;
	CONVERSATION: DurableObjectNamespace<import("./src/index").Conversation>;
	NEURON_COORDINATOR: DurableObjectNamespace<import("./src/index").NeuronCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Conversation" | "NeuronCoordinator";
	}
